...
Right now this is a **proof of concept** of a tinder style image swiper for smash or pass.
...
- [ ] Comments describing each section of the code
- [ ] Improvements to the presentation
  - [ ] Title above the images, add to .json
